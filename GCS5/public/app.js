...
import 'plugins/GCS5/dashboard/index';
...
routes
.otherwise({
  redirectTo: `/${chrome.getInjected('kbnDefaultAppId', 'dashboard')}`
});
...
.setRootController('kibana', function ($scope, courier, config) {
  ...
  $scope.chrome.setShowAppsLink(false); // PAC Feature: Hide left navigration
